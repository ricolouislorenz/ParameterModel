...
import logo512 from '../assets/images/websiteLogo.png'; 
      ...
      <Toolbar>
        <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
          <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>
            <img src={logo512} alt="Website Logo" style={{ height: 40, marginRight: 10 }} />
          ...
          <Box sx={{ display: 'flex', gap: 2, marginLeft: 4 }}>
            ...
            <Button color="inherit" component={Link} to="/rewardsmodel">Reward Model</Button>
