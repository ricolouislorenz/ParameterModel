...
const Homepage = () => {
  return (
    <Box sx={{ background: 'linear-gradient(135deg, #4a90e2, #f5a623)', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <Grid container spacing={4} sx={{ paddingTop: '40px', paddingBottom: '40px', justifyContent: 'center', textAlign: 'center' }}>
          <Grid item xs={12}>
            <Box sx={{ color: 'black' }}>
              ...
              <Box sx={{ marginTop: '40px', display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap' }}>
                <Button variant="contained" sx={{ backgroundColor: '#424242', padding: '10px 20px' }} component={Link} to="/questionnaire">
                  Questionnaire
                </Button>
                <Button variant="contained" sx={{ backgroundColor: '#424242', padding: '10px 20px' }} component={Link} to="/rewardsmodel">
                  Reward Model
                </Button>
